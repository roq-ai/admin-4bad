...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'company.update': {
    roles: ['admin', 'team-member', 'client-manager', 'customer-support'],
...
const tenantRoles: string[] = ['admin', 'team-member', 'client-manager', 'customer-support'];
