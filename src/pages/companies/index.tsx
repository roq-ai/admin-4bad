...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'client_manager.count', 'customer.count', 'customer_support.count', 'team_member.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('client_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'client_manager',
          header: 'Client Manager',
          accessorKey: 'client_manager',
          cell: ({ row: { original: record } }: any) => record?._count?.client_manager,
        }
      : null,
    ...
    hasAccess('customer_support', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.customer_support,
        }
      : null,
