  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to admin - Streamlining Client Management. Your one-stop portal for handling all client information such as name, email, phone, and services, just like ManyRequests."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/uploads/141103282695035fa1380/95cdfeef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhZG1pbiUyMHBvcnRhbHxlbnwwfHx8fDE2OTQ3Nzc4Nzd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@zal3wa?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Damian Zaleski`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to admin - Streamlining Client Management. Your one-stop portal for handling all client information such as name, email, phone, and services, just like ManyRequests.`}
            </Text>
            <Box
